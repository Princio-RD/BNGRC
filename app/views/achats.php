...
<body>
  ...
  <?php include __DIR__ . '/partials/header.php'; ?>
      ...
      <form action="<?php echo Flight::get('flight.base_url'); ?>/achats" method="get" class="filter-form">
          ...
          <?php if (!empty($besoins_restants)): ?>
            <?php foreach ($besoins_restants as $b): ?>
              <tr>
                ...
                <td>
                  <form action="<?php echo Flight::get('flight.base_url'); ?>/achats/process" method="post" style="display:flex; gap:5px;">
