...
<?php include __DIR__ . '/partials/header.php'; ?>
    ...
    <div class="form-card">
      ...
      <form method="POST" action="<?php echo Flight::get('flight.base_url'); ?>/dons" class="form-inline">
        ...
        <?php if (!empty($dons)): ?>
          <?php foreach ($dons as $d): ?>
            <tr>
              ...
              <td><?= $d['date_don'] ?></td>
              <td>
                <a href="<?php echo Flight::get('flight.base_url'); ?>/dons/delete/<?= $d['id_don'] ?>" class="btn btn-delete" onclick="return confirm('Supprimer ce don ?')">Supprimer</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
    ...
    <div class="form-card">
      ...
      <form method="POST" action="<?php echo Flight::get('flight.base_url'); ?>/dons/argent" class="form-inline">
        ...
        <?php if (!empty($dons_argent)): ?>
          <?php foreach ($dons_argent as $da): ?>
            <tr>
              ...
              <td><?= $da['date_don'] ?></td>
              <td>
                <a href="<?php echo Flight::get('flight.base_url'); ?>/dons/argent/delete/<?= $da['id_don_argent'] ?>" class="btn btn-delete" onclick="return confirm('Supprimer ce don d\'argent ?')">Supprimer</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
