  ...
  <?php include __DIR__ . '/partials/header.php'; ?>
      ...
      <div class="charts-container">
        <div class="chart-card">
          <h4><i class="fa-solid fa-chart-line"></i> Évolution des distributions</h4>
          <div class="chart-wrapper">
            <canvas id="distributionChart"></canvas>
          </div>
        </div>
        <div class="chart-card">
          <h4><i class="fa-solid fa-chart-pie"></i> Répartition des dons</h4>
          <div class="chart-wrapper">
            <canvas id="donationsChart"></canvas>
          </div>
        </div>
        <div class="chart-card">
          <h4><i class="fa-solid fa-chart-bar"></i> Besoins par ville</h4>
          <div class="chart-wrapper">
