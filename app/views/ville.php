<?php include __DIR__ . '/partials/header.php'; ?>
    ...
    <div class="form-card">
      ...
      <form method="POST" action="<?php echo Flight::get('flight.base_url'); ?>/ville" class="form-inline">
        ...
        <?php if (!empty($villes)): ?>
          <?php foreach ($villes as $v): ?>
            <tr>
              ...
              <td>
                <a href="<?php echo Flight::get('flight.base_url'); ?>/ville/delete/<?= $v['id_ville'] ?>" class="btn btn-delete" onclick="return confirm('Supprimer cette ville ?')">Supprimer</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
