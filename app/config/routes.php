...
Flight::route('POST /dons/argent/update/@id:[0-9]+', function ($id) {
    HomeController::donArgentUpdate($id);
});

Flight::route('/dons/argent/delete/@id:[0-9]+', function ($id) {
    HomeController::donArgentDelete($id);
});
